...
docker run --name blog_python -d -v /home/travis/build/vernvern/log:/opt/log -v /home/travis/build/vernvern/blog:/opt/src -p 5000:5000 --network net --ip 172.18.0.3 blog:python-3.6.4
